...
public class ListDrawerItemAdapter extends ArrayAdapter<DrawerItem> {
	 ...
	 */
	public ListDrawerItemAdapter(Context context, int textViewResourceId,
			ArrayList<DrawerItem> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (i != null) {
			...
			TextView notification = (TextView) v
