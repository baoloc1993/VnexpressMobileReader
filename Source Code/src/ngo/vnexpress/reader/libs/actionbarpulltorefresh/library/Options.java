...
/**
 * Allows you to specify a number of configuration options when setting up a
 * {@link PullToRefreshLayout}.
 */
public final class Options {
	...
	public static class Builder {
		 ...
		 */
		public Builder environmentDelegate(
		...
		/**
		 * Disable the header 'minimization', which by default means that the
		 * majority of the header is hidden, leaving only the progress bar still
		 * showing.
		 */
		...
		/**
		 * Enable header 'minimization', which by default means that the
		 * majority of the header is hidden, leaving only the progress bar still
		 * showing.
		 */
