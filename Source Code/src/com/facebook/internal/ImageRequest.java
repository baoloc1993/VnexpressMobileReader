...
public class ImageRequest {
	...
	public static URI getProfilePictureUrl(String userId, int width, int height)
		...
		Uri.Builder builder = new Uri.Builder().encodedPath(String.format(
				PROFILEPIC_URL_FORMAT, userId));
